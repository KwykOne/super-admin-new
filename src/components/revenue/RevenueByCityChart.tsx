...
export function RevenueByCityChart({ data, loading, onPeriodChange }: RevenueByCityChartProps) {
    ...
    <Card className="h-full">
      <CardHeader className="flex flex-row items-center justify-between">
        <div>
          ...
          <CardDescription>Distribution of revenue across different cities</CardDescription>
        </div>
        {onPeriodChange && (
          <PeriodFilter 
